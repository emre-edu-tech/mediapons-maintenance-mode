...
<body class="h-full">
    ...
    <main class="lg:max-w-6xl mx-auto grid min-h-full place-items-center bg-white px-6 py-16 lg:px-0">
        <div class="text-center">
            <h3 class="site-title mb-6 text-xl"><?php echo get_option('mp_company_name', get_bloginfo('name')) ? get_option('mp_company_name', get_bloginfo('name')) : 'Enter Company Name' ?></h3>
            ...
            <div class="mt-6 text-base leading-7 text-gray-600">
                <?php echo get_option('mp_maintenance_description', __('This is a sample description why your website is in maintenance mode.', 'mp-maintenance')) ?>
            </div>
            <div class="mt-10 flex items-center justify-center gap-x-6">
                <?php if(get_option('mp_email_button_text')): ?>
                ...
                <?php if(get_option('mp_phone_button_number')): ?>
